        ...
        <div class="mx-20">
            <div class="caroussel slick-slider drop-shadow-2xl">
                <div
                    ...
                    <div class=" h-60">
                        <h1 class="font-bold capitalize">Créer votre carte digitale</h1>
                        <p class="pb-5 pt-5 text-lg">Créez votre carte de visite digitale en quelques instants
                            seulement. Avec notre interface intuitive, tout est à portée de clic pour une expérience sans faille
                        </p>
                    </div>
                ...
                <div
                    ...
                    <div class=" h-60">
                        <h1 class="font-bold capitalize">Modification dynamique</h1>
                        <p class="pb-5 pt-5 text-lg">
                            Mettez à jour vos coordonnées en temps réel, vos contacts recevront automatiquement les changements. Plus de soucis de données obsolètes
                        </p>
                    </div>
                    <div class="flex items-center justify-between">
                ...
                <div
                    ...
                    <div class=" h-60">
                        <h1 class="font-bold capitalize">Déclaration de Perte</h1>
                        <p class="pb-5 pt-5 text-lg">
                            Déclarez la perte de votre carte physique et récupérez-en une nouvelle rapidement. Soyez toujours prêt à reseauter
                        </p>
                    </div>
                    <div class="flex items-center justify-between ">
                ...
                <div
                    class="bg-blue-950 item p-5 border-solid border-violet-700 border-2 rounded-xl mx-5 drop-shadow-lg hover:scale-95 transition-all duration-500 h-80">
                    <div class=" h-60">
                        <h1 class="font-bold capitalize">Rejoignez des milliers de professionnels satisfaits</h1>
                        <p class="pb-5 pt-5 text-lg">
                            Des milliers de professionnels font confiance à ZETCHA pour gérer leur image professionnelle. Rejoignez-nous dès maintenant. Laissez un avis
                        </p>
                    </div>
                    <div class="flex items-center justify-between ">
