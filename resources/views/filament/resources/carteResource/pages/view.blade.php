...
<x-filament::page>
    @php
        ...
        $eyestyles = ['circle', 'square'];
        $gradientTypes = ['vertical', 'horizontal', 'diagonal', 'inverse_diagonal', 'radial'];
    @endphp
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    ...
    <div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
      ...
      <p class="mb-8 leading-relaxed">Plan Tarifaire: {{ $record->planTarifaire->name ."(".$record->planTarifaire->price.")" }}</p>
